...
class _AddTaskState extends State<AddTask> {
 ...
 addTask() async {
   final response = await http.post("https://panel.serarinne.my.id/zonapelajar/istask.php",
       body: {"nama": nama, "ruang": ruang, "jam": jam, "hari": hari});
   String status = response.body;
   if (status == "1") {
     _showDialog("Berhasil Ditambahkan...");
   } else if (status == "0") {
 ...
 void _showDialog (String message) {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child:Scaffold(
        appBar: AppBar(title: Text("Add Task", style: TextStyle(color: Colors.black),), backgroundColor: Colors.white,),
